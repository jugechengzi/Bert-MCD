...
from train_util_bert_bcr import train_bert_classifier_onegpu
...
for epoch in range(args.epochs):
    ...
    start = time.time()
    model.train()
    precision, recall, f1_score, accuracy = train_bert_classifier_onegpu(model,opt_pred, train_loader, device, args,mode='train')
    ...
    precision, recall, f1_score, accuracy=train_bert_classifier_onegpu(model, opt_pred, dev_loader, device, args,mode='dev')
    ...
    precision, recall, f1_score, accuracy= train_bert_classifier_onegpu(model, opt_pred, annotation_loader, device, args,mode='test')
